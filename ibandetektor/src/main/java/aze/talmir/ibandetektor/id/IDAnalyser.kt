...
import aze.talmir.ibandetektor.analyser.BlockWrapper
import aze.talmir.ibandetektor.id.processor.MrzTextPreProcessor
import aze.talmir.ibandetektor.id.processor.MrzTextPreProcessor.MIN_POSSIBLE_CHAR_LENGTH_PER_LINE
...
class IDAnalyser(
    scannerOverlay: ScannerOverlay, mlService: MLService
